...
<head>
    ...
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/uniform/css/uniform.default.css"
          rel="stylesheet" type="text/css"/>
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css"
          rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL PLUGIN STYLES -->
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css"
          rel="stylesheet" type="text/css"/>
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/fullcalendar/fullcalendar.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/jqvmap.css"
          rel="stylesheet" type="text/css"/>
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"
          rel="stylesheet" type="text/css"/>
    <!-- END PAGE LEVEL PLUGIN STYLES -->
    <!-- BEGIN PAGE STYLES -->
    <link href="${pageContext.servletContext.contextPath }/assets/admin/pages/css/tasks.css" rel="stylesheet"
          type="text/css"/>
    <!-- END PAGE STYLES -->
    <link href="${pageContext.servletContext.contextPath }/assets/global/plugins/jstree/dist/themes/default/style.min.css"
          rel="stylesheet" type="text/css"/>
    <!-- BEGIN THEME STYLES -->
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="${pageContext.servletContext.contextPath }/index.shtml">
                <img src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/logo.png" alt="logo"
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                <%--////////////////////////////////////end--%>
  <%--              <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar_shop">
                    ...
                    <ul class="dropdown-menu">
                        <li class="external">
                            &lt;%&ndash;<h3><span class="bold">请选择门店：</span></h3>&ndash;%&gt;
                            &lt;%&ndash; <a href="extra_profile.html">view all</a>&ndash;%&gt;
                        </li>
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height: 250px;" data-handle-color="#637283">
                                <c:forEach items="${userAuthorizatioStoreList}" var="userAuthorization"
                                           varStatus="status">
                                    <li>
                                        <a href="javascript:;"
                                    ...
                                    </span>${userAuthorization.businessName}</span>
                                        </a>
                                    </li>
                                </c:forEach>
                            </ul>
                        ...
                        <%--<li>--%>
                            <%--<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">--%>
                                <%--<li>--%>
									...
									<%--<span class="photo">--%>
									<%--<img src="${pageContext.servletContext.contextPath }/assets/admin/layout3/img/avatar2.jpg"--%>
                                ...
                                <%--<li>--%>
                                    <%--<a href="inbox.html?a=view">--%>
									<%--<span class="photo">--%>
									<%--<img src="${pageContext.servletContext.contextPath }/assets/admin/layout3/img/avatar3.jpg"--%>
                                         <%--class="img-circle" alt="">--%>
									<%--</span>--%>
									<%--<span class="subject">--%>
									<%--<span class="from">--%>
                                ...
                                <%--<li>--%>
                                    <%--<a href="inbox.html?a=view">--%>
									<%--<span class="photo">--%>
									<%--<img src="${pageContext.servletContext.contextPath }/assets/admin/layout3/img/avatar1.jpg"--%>
                                         <%--class="img-circle" alt="">--%>
									<%--</span>--%>
									<%--<span class="subject">--%>
									<%--<span class="from">--%>
                    ...
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="true">
                        <img alt="" class="img-circle"
                             src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar3_small.jpg"/>
					<span class="username username-hide-on-mobile">
                        ${userFormMap.accountName} </span>
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="site_statistics_loading">
                                <img src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/loading.gif"
                                     alt="loading"/>
                            </div>
                                    ...
                                    <div class="scroller" style="height: 290px;" data-always-visible="1"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 user-info">
                                                <img alt=""
                                                     src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar.png"
                                ...
                                <ul class="chats">
                                    <li class="in">
                                        <img class="avatar" alt=""
                                             src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar1.jpg"/>
                                    ...
                                    <li class="out">
                                        <img class="avatar" alt=""
                                             src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar2.jpg"/>
                                    ...
                                    <li class="out">
                                        <img class="avatar" alt=""
                                             src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar3.jpg"/>
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                            ...
                            <ul class="media-list list-items">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar4.jpg"
                                         alt="...">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar6.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar7.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar8.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar9.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar10.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="${pageContext.servletContext.contextPath }/assets/admin/layout/img/avatar11.jpg"
                                         alt="...">
...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="${pageContext.servletContext.contextPath }/assets/global/plugins/respond.min.js"></script>
<script src="${pageContext.servletContext.contextPath }/assets/global/plugins/excanvas.min.js"></script>
<![endif]-->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery-migrate.min.js"
        type="text/javascript"></script>
<!-- IMPORTANT! Load jquery-ui.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery-ui/jquery-ui.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/js/highstock.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-daterangepicker/moment.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap/js/bootstrap.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery.blockui.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery.cokie.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/uniform/jquery.uniform.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js"
        type="text/javascript"></script>
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js"
        type="text/javascript"></script>
<script src="${pageContext.servletContext.contextPath }/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/flot/jquery.flot.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/flot/jquery.flot.resize.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/flot/jquery.flot.categories.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery.pulsate.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-daterangepicker/moment.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js"
        type="text/javascript"></script>
<!-- IMPORTANT! fullcalendar depends on jquery-ui.min.js for drag & drop support -->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/fullcalendar/fullcalendar.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jquery.sparkline.min.js"
        type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/scripts/metronic.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/admin/layout/scripts/layout.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/admin/layout/scripts/quick-sidebar.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/admin/layout/scripts/demo.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/admin/pages/scripts/index.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/admin/pages/scripts/tasks.js"
        type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- datatables -->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js"
        type="text/javascript"></script>
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/datatables/all.min.js"
        type="text/javascript"></script>
<%--<script src="${pageContext.servletContext.contextPath }/assets/global/plugins/datatables/plugins/fnProcessingIndicator.js"
    type="text/javascript"></script>--%>
<!-- end datatables -->
<script
        src="${pageContext.servletContext.contextPath }/assets/global/plugins/jstree/dist/jstree.min.js"
        type="text/javascript"></script>
<!-- lanyuan js -->
...
<script type="text/javascript"
        src="${pageContext.servletContext.contextPath}/common/common.js"></script>
...
<script type="text/javascript" src="${ctx}/common/map.js"></script>
<!-- end lanyuan js -->
<script>
    var rootPath = "${ctx}";
    jQuery(document)
