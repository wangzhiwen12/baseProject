	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<%-- name="offsetType"--%>
					<select id="groupType" name="roleFormMap.organization_code"   class="table-group-action-input form-control input-inline input-small input-sm checkaccgg">
					</select>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<%--name="offsetType"--%>
					<select id="storeType" name="roleFormMap.store_code" class="table-group-action-input form-control input-inline input-small input-sm checkatt">
					</select>
				</div>
			</div>

			<input type="hidden" class="form-control"  name="roleFormMap.organization_name" id="organization_name">
			<input type="hidden" class="form-control"  name="roleFormMap.business_name" id="business_name">
