...
<title id="js-meta-title">微页面预览</title>
...
<link href="${pageContext.request.contextPath}/css/wx-pc.css"
	rel="stylesheet" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/wpage/css/chosen.jquery.20150826.min.css"
	onerror="_cdnFallback(this)" media="screen">
<!-- ▼ Common CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/wpage/css/jquery.ui.20151022.min.css"
	onerror="_cdnFallback(this)" media="screen">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/wpage/css/bootstrap_140705.min.css"
	onerror="_cdnFallback(this)" media="screen">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/wpage/css/usercenter_preview.css"
	onerror="_cdnFallback(this)" media="screen">
<!-- ▲ Common CSS -->

<script type="text/javascript"
	src="${pageContext.request.contextPath}/wpage/js/libs/jquery-1.9.1.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/wshop/wpage/wpageOperation.js"></script>
