...
<div class="col-md-12">
    <div class="alert alert-warning alert-block">
        <table>
            <tr>
                <td align="center" colspan="2"><h1>移动营销系统</h1></td>
            </tr>
            <tr>
                <td>
                    <div class="topBtn" style="font-size: 15px;">
...
<div class="col-md-6">
    <div class="alert alert-danger">
        ...
        <img alt="蓝缘系统的支付连接" src="${pageContext.request.contextPath}/images/zhifubao.png" title="蓝缘系统的支付连接"> <span
            title="蓝缘系统的支付连接" style="font-size: 20px;color: blue;">支付宝账号是:mmm333zzz520@163.com</span><br> <span
            title="蓝缘系统的支付连接" style="font-size: 20px;color: blue;">支付地址: 支付地址已经关闭,亲可以直接转到支付宝账号上，记得备注哦！</span>
    </div>
</div>
<div class="col-md-6">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td><span title="蓝缘系统的支付连接"
                          style="font-size: 17px; color: blue;">支付地址已经关闭,亲可以直接转到支付宝账号上，<span
                        style="font-size: 17px; color: red;">捐助请备注哦！谢谢！</span></span></td>
