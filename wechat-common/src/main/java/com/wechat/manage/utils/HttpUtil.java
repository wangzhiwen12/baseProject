 ...
 * @Path: com.wangfj.back.utilHttpUtil.java
 * @Create By chengsj
...
public class HttpUtil {
	 ...
	 * http get 请求共用方法
	 *
	 * @Methods Name sendGet
	 * @Create In 2016年9月23日 By kongqf
	 * @param reqUrl
	 * @param params
	 * @return
	 * @throws Exception
	...
	/**
	 * http post 请求 json 数据
	 *
	 * @Methods Name sendPostBuffer
	 * @Create In 2016年9月23日 By kongqf
	 * @param urls
	 * @param params
	 * @return
