...
<script type="text/javascript">
	...
	$('#sub').bind('click',function(){
		...
		$.ajax({
		    type: 'post',
		    url: '${pageContext.request.contextPath}/material/imageAdd/upload.shtml',
		    data: formData,  
		    dataType: "json",
	        async: false,  
	        cache: false,  
		    ...
		    success: function(paramMap) {
		    	if(paramMap.success == 'success'){
		    		alert("上传成功");
		    		paramMap.material.localUrl = $('#preview_size_fake').attr("src");
		    		window.parent.divSwitch(paramMap.material);
