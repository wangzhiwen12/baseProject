                                            ...
                                            <TABLE cellSpacing=0 cellPadding=0 width=534 border=0>
                                                ...
                                                <TR>
                                                    ...
                                                    <TD class=htd align=middle width=479 bgColor=#f7f7f7
                                                        ...
                                                        <P><FONT
                                                                class=red
                                                                size="5"><b>您的访问的页面可能被删除或不存在。</b></FONT><BR><BR><font
                                                                color="blue" size="3">你的IP已经记录，请勿进行非法操作！！</font><BR><BR><BR>
            ...
            <TR>
                <TD class=bg align=middle width=*>
                    <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                        <TBODY>
                        <TR>
                            <TD><IMG src="${pageContext.servletContext.contextPath }/404/4.gif" width="17" height="18">
                            </TD>
                            <TD width="100%"
                                background="${pageContext.servletContext.contextPath }/404/6.gif"></TD>
                            <TD><IMG
                                    src="${pageContext.servletContext.contextPath }/404/5.gif" width="17" height="18">
                            </TD>
                        </TR>
                        </TBODY>
                    </TABLE>
